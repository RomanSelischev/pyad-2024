...
ratings = pd.read_csv("../../../Downloads/Ratings.csv", low_memory=False)
books = pd.read_csv("../../../Downloads/Books.csv", low_memory=False)
...
if svd_good.empty:
    print(f"Рекомендация: Нет книг с предсказанным рейтингом >= 8 для пользователя {top_user}.")
    exit(0)
...
================================================================================
9. Название книги: The Hobbit : The Enchanting Prelude to The Lord of the Rings
   Автор: J.R.R. TOLKIEN
   Издатель: Del Rey
   ISBN: 0345339681
   Предсказанный рейтинг (LinReg): 8.69
   Предсказанный рейтинг (SVD): 8.30
--------------------------------------------------------------------------------
15. Название книги: Wizard and Glass (The Dark Tower, Book 4)
   Автор: Stephen King
   Издатель: Signet Book
   ISBN: 0451194861
   Предсказанный рейтинг (LinReg): 8.42
   Предсказанный рейтинг (SVD): 8.03
--------------------------------------------------------------------------------
29. Название книги: The Lion, the Witch and the Wardrobe (Full-Color Collector's Edition)
   Автор: C. S. Lewis
   Издатель: HarperTrophy
   ISBN: 0064409422
   Предсказанный рейтинг (LinReg): 8.29
   Предсказанный рейтинг (SVD): 8.40
--------------------------------------------------------------------------------
12. Название книги: Cat in the Hat (I Can Read It All by Myself Beginner Books)
   Автор: Seuss
   Издатель: Random House Books for Young Readers
   ISBN: 0394900014
   Предсказанный рейтинг (LinReg): 8.17
   Предсказанный рейтинг (SVD): 8.25
--------------------------------------------------------------------------------
31. Название книги: The Very Best Baby Name Book in the Whole Wide World
   Автор: Bruce Lansky
   Издатель: Meadowbrook Press
   ISBN: 088166247X
   Предсказанный рейтинг (LinReg): 8.16
   Предсказанный рейтинг (SVD): 8.01
--------------------------------------------------------------------------------
